...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		...
		<form role="form" method="post" action="${pageContext.request.contextPath}/create">
			...
			<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-md-6 col-sm-offset-3"><input type="submit" value="Register" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
			</div>
		</form>
	</div>
</div>
